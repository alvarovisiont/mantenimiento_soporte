		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2 text-center">
				<div class="alert alert-success" id="aviso" style="display: none;">
				 <h5 class="">Conversación eliminado con éxito&nbsp;<i class="fa fa-exclamation-circle"></i></h5>
			    </div>
			</div>
		</div>
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <div class="box-tools pull-right">
                <div class="has-feedback">
                  <input type="text" class="form-control input-sm buscar_correo" placeholder="Buscar Correos">
            ...
            <div class="box-body no-padding">
              <div class="mailbox-controls">
                ...
                <div class="btn-group">
                  <button type="button" class="btn btn-default btn-sm eliminar_correos"><i class="fa fa-trash-o"></i></button>
                </div>
                <!-- /.btn-group -->
                  ...
                  <tbody>
	                  ...
	                  @foreach($correos as $row)
		                  <tr>
		                    ...
		                    @endif
		                    <td class="mailbox-name"><a href="{{url('/correspondencia/dialogo/')}}{{"/".$row->id}}">{{$mail->iniciado_enviado($row->id)}}</a></td>
